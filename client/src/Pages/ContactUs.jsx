...
export default function ContactUs() {
  ...
  // Preload Contact Us page translations when language changes
  useEffect(() => {
    if (currentLanguage !== 'en') {
      const contactUsTexts = [
        // Hero section
        "Contact Us",
      ...
      preloadTranslations(contactUsTexts);
    }
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#001f4d] via-[#003366] to-[#004080]">
      ...
      <section className="bg-gradient-to-r from-[#002D72] to-blue-600 shadow-lg py-20 px-6 text-center max-w-5xl mx-auto rounded-b-3xl mt-8">
        ...
        <p className="text-lg md:text-xl max-w-2xl mx-auto text-yellow-100 font-medium drop-shadow-md">
          <T>We're here to help. Reach out via phone, email, WhatsApp, or visit our branches.</T>
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto p-8 grid gap-10 sm:grid-cols-2 lg:grid-cols-3 mt-16">
        ...
        <div className={cardClass}>
          ...
          <p className="text-gray-800 leading-relaxed">
            <T>Toll-Free:</T> <a href="tel:18002334526" className="underline hover:text-[#002D72]">1800 233 4526</a>,{' '}
            <a href="tel:18001022636" className="underline hover:text-[#002D72]">1800 102 2636</a><br />
            <T>Landline:</T> 020-24480797, 020-24504118, 020-24504117
          </p>
        </div>
        ...
        <div className={cardClass}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#002D72]">
              <T>WhatsApp Banking</T>
            </h2>
          </div>
          <p className="text-gray-800 leading-relaxed">
            <T>Send</T> <strong className="text-yellow-400">"<T>Hi</T>"</strong> <T>to</T>{' '}
        ...
        <div className={cardClass + " sm:col-span-2 lg:col-span-3"}>
          ...
          <address className="not-italic text-gray-800 leading-relaxed space-y-2">
            <T>Bank of Maharashtra Central Office,</T><br />
            <T>Lokmangal, 1501, Shivajinagar, Pune - 411005</T><br />
            <T>Phone:</T> 020-25532731, 733, 734, 735, 736<br />
            <T>Fax:</T> 020-25532728
          </address>
        </div>
      </section>
